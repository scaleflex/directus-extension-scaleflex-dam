...
function matrix(el, selfOnly) {
  ...
  if (typeof el === 'string') {
    ...
    do {
      var transform = css$4(el, 'transform');
...
function getRect(el, relativeToContainingBlock, relativeToNonStaticParent, undoScale, container) {
  ...
  if ((relativeToContainingBlock || relativeToNonStaticParent) && el !== window) {
    ...
    if (!IE11OrLess) {
      do {
        if (container && container.getBoundingClientRect && (css$4(container, 'transform') !== 'none' || relativeToNonStaticParent && css$4(container, 'position') !== 'static')) {
          var containerRect = container.getBoundingClientRect(); // Set relative to edges of padding box of container

          top -= containerRect.top + parseInt(css$4(container, 'border-top-width'));
          left -= containerRect.left + parseInt(css$4(container, 'border-left-width'));
...
function lastChild(el, selector) {
  ...
  while (last && (last === Sortable.ghost || css$4(last, 'display') === 'none' || selector && !matches(last, selector))) {
  ...
  return {
    captureAnimationState: function captureAnimationState() {
      ...
      children.forEach(function (child) {
        if (css$4(child, 'display') === 'none' || child === Sortable.ghost) return;
    ...
    animate: function animate(target, currentRect, toRect, duration) {
      if (duration) {
        css$4(target, 'transition', '');
        css$4(target, 'transform', '');
        ...
        css$4(target, 'transform', 'translate3d(' + translateX + 'px,' + translateY + 'px,0)');
        this.forRepaintDummy = repaint(target); // repaint

        css$4(target, 'transition', 'transform ' + duration + 'ms' + (this.options.easing ? ' ' + this.options.easing : ''));
        css$4(target, 'transform', 'translate3d(0,0,0)');
...
supportDraggable = documentExists && !ChromeForAndroid && !IOS && 'draggable' in document.createElement('div'),
  ...
  var elCSS = css$4(el),
      ...
      firstChildCSS = child1 && css$4(child1),
      secondChildCSS = child2 && css$4(child2),
...
_detectNearestEmptySortable = function _detectNearestEmptySortable(x, y) {
  ...
  if (!supportCssPointerEvents && ghostEl) {
    css$4(ghostEl, 'display', 'none');
  }
},
    _unhideGhostForTarget = function _unhideGhostForTarget() {
  if (!supportCssPointerEvents && ghostEl) {
    css$4(ghostEl, 'display', '');
  }
...
/** @lends Sortable.prototype */
{
  ...
  evt) {
    if (tapEvt) {
      ...
      if (ghostEl) {
        ...
        css$4(ghostEl, 'webkitTransform', cssMatrix);
        css$4(ghostEl, 'mozTransform', cssMatrix);
        css$4(ghostEl, 'msTransform', cssMatrix);
        css$4(ghostEl, 'transform', cssMatrix);
        lastDx = dx;
        lastDy = dy;
        touchEvt = touch;
      }
  ...
  _appendGhost: function _appendGhost() {
    ...
    if (!ghostEl) {
      ...
      if (PositionGhostAbsolutely) {
        ...
        while (css$4(ghostRelativeParent, 'position') === 'static' && css$4(ghostRelativeParent, 'transform') === 'none' && ghostRelativeParent !== document) {
      ...
      css$4(ghostEl, 'transition', '');
      css$4(ghostEl, 'transform', '');
      css$4(ghostEl, 'box-sizing', 'border-box');
      css$4(ghostEl, 'margin', 0);
      css$4(ghostEl, 'top', rect.top);
      css$4(ghostEl, 'left', rect.left);
      css$4(ghostEl, 'width', rect.width);
      css$4(ghostEl, 'height', rect.height);
      css$4(ghostEl, 'opacity', '0.8');
      css$4(ghostEl, 'position', PositionGhostAbsolutely ? 'absolute' : 'fixed');
      css$4(ghostEl, 'zIndex', '100000');
      css$4(ghostEl, 'pointerEvents', 'none');
      Sortable.ghost = ghostEl;
      container.appendChild(ghostEl); // Set transform-origin

      css$4(ghostEl, 'transform-origin', tapDistanceLeft / parseInt(ghostEl.style.width) * 100 + '% ' + tapDistanceTop / parseInt(ghostEl.style.height) * 100 + '%');
    }
  },
  ...
  fallback) {
    ...
    if (fallback) {
      ...
      css$4(dragEl, 'transform', 'translateZ(0)');
    }
    ...
    if (Safari) {
      css$4(document.body, 'user-select', 'none');
    }
  },
    ...
    : putSortable === this || (this.lastPutMode = activeGroup.checkPull(this, activeSortable, dragEl, evt)) && group.checkPut(this, activeSortable, dragEl, evt))) {
      ...
      if (!elLastChild || _ghostIsLast(evt, vertical, this) && !elLastChild.animated) {
        ...
        if (direction !== 0) {
          ...
          } while (sibling && (css$4(sibling, 'display') === 'none' || sibling === ghostEl));
  ...
  evt) {
    ...
    if (Safari) {
      css$4(document.body, 'user-select', '');
    }

    css$4(dragEl, 'transform', '');
...
const _hoisted_2$3 = { id: "sfx-result" };
const _hoisted_3$3 = {
  key: 0,
  class: "sfx-item"
};
const _hoisted_4$3 = { class: "sfx-item-inner" };
const _hoisted_5$2 = { class: "btn-drag-item" };
const _hoisted_6$2 = {
    ...
    ($setup.isTokenAndSecExists)
      ...
      : (openBlock(), createElementBlock("div", _hoisted_37, [
          createVNode(_component_VCard, { style: {"max-width":"100%","margin-top":"20px"} }, {
            default: withCtx(() => [
              createVNode(_component_VCardTitle, { style: {"color":"tomato"} }, {
                default: withCtx(() => [
                  createVNode(_component_VIcon, {
                    name: "report",
                    small: true
...
var InterfaceComponent = /*#__PURE__*/_export_sfc(_sfc_main$3, [['render',_sfc_render$3],['__file',"interface.vue"]]);
...
const _hoisted_1$2 = { style: {"margin-top":"20px","padding":"0 10px"} };
const _hoisted_2$2 = { style: {"display":"flex","flex-direction":"column","align-content":"center"} };
const _hoisted_3$2 = { style: {"display":"flex","background":"var(--theme--navigation--project--background)","padding":"5px 8px","border-radius":"4px","align-items":"center"} };
const _hoisted_4$2 = {
  href: "#",
  target: "_blank",
  class: "external-link",
...
const _hoisted_6$1 = { class: "sfx-padding-box" };
      ...
      createElementVNode("div", _hoisted_1$2, [
        createElementVNode("div", _hoisted_2$2, [
          ...
          createElementVNode("a", _hoisted_4$2, [
            ...
            _cache[10] || (_cache[10] = createElementVNode("span", { style: {"margin-left":"4px","font-size":"14px","display":"block"} }, "Document", -1 /* HOISTED */))
          ])
        ])
      ])
    ]),
        ...
        default: withCtx(() => [
          ...
          createVNode(_component_VCardText, { style: {"padding":"15px","width":"100%","position":"relative"} }, {
            default: withCtx(() => [
              ...
              createElementVNode("a", _hoisted_5$1, [
                createVNode(_component_VIcon, {
                  name: "house",
                  small: true,
...
var ModuleComponent$1 = /*#__PURE__*/_export_sfc(_sfc_main$2, [['render',_sfc_render$2],['__file',"module.vue"]]);
...
const _hoisted_1$1 = { class: "media-container" };
const _hoisted_2$1 = ["onMouseover"];
...
const _hoisted_6 = { class: "media-item circle icon-wrapper" };
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", _hoisted_1$1, [
    (openBlock(true), createElementBlock(Fragment, null, renderList($options.displayedItems, (item, index) => {
      return (openBlock(), createElementBlock("div", {
        ...
        ($options.isImage(item.type))
          ? (openBlock(), createElementBlock("div", {
              ...
              alt: item.name
            }, null, 12 /* STYLE, PROPS */, _hoisted_3$1))
      ...
      ], 46 /* CLASS, STYLE, PROPS, NEED_HYDRATION */, _hoisted_2$1))
    }), 128 /* KEYED_FRAGMENT */)),
...
var DisplayComponent = /*#__PURE__*/_export_sfc(_sfc_main$1, [['render',_sfc_render$1],['__scopeId',"data-v-e6bd5544"],['__file',"display.vue"]]);
...
const _hoisted_1 = { style: {"margin-top":"20px","padding":"0 10px"} };
const _hoisted_2 = { style: {"display":"flex","flex-direction":"column","align-content":"center"} };
const _hoisted_3 = { style: {"display":"flex","align-items":"center","background":"var(--theme--navigation--project--background)","padding":"5px 8px","border-radius":"4px","margin-top":"8px"} };
const _hoisted_4 = {
  href: "#",
  target: "_blank",
  class: "external-link",
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock(_component_private_view, { title: "Scaleflex DAM" }, {
      ...
      createElementVNode("div", _hoisted_1, [
        createElementVNode("div", _hoisted_2, [
          createElementVNode("div", {
            ...
            _cache[1] || (_cache[1] = createElementVNode("span", { style: {"margin-left":"4px","font-size":"14px","display":"block"} }, "Scaleflex DAM", -1 /* HOISTED */))
          ]),
          createElementVNode("div", _hoisted_3, [
            ...
            _cache[2] || (_cache[2] = createElementVNode("span", { style: {"margin-left":"4px","font-size":"14px","display":"block"} }, "Assets Library", -1 /* HOISTED */))
          ]),
          createElementVNode("a", _hoisted_4, [
            ...
            _cache[3] || (_cache[3] = createElementVNode("span", { style: {"margin-left":"4px","font-size":"14px","display":"block"} }, "Document", -1 /* HOISTED */))
          ])
        ])
      ])
    ]),
    default: withCtx(() => [
      ...
      _cache[5] || (_cache[5] = createElementVNode("div", { style: {"margin":"32px"} }, [
        createElementVNode("div", { id: "sfx-dam-widget" })
      ], -1 /* HOISTED */))
    ]),
    _: 1 /* STABLE */
  }))
...
const interfaces = [e0];const displays = [e2];const layouts = [];const modules = [e1,e3];const panels = [];const themes = [];const operations = [];
